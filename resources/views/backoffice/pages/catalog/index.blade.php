        ...
        <div class="card">
                ...
                <div class="d-flex">
                    <div class="text-muted">
                        ...
                        <div class="mx-2 d-inline-block">
                            <input type="text" class="form-control form-control-sm" value="{{ request('per_page', 8) }}" size="3"
                    ...
                    <div class="ms-auto text-muted">
                        ...
                        <div class="ms-2 d-inline-block">
                            <input type="text" class="form-control form-control-sm" aria-label="Search catalog">
                        </div>
                    </div>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        @php
                            $no = ($catalogs->currentPage() - 1) * $catalogs->perPage() + 1;
                        @endphp
                                        ...
                                        <div class="dropdown-menu dropdown-menu-start"
                                            ...
                                            <form action="{{ route('catalog.destroy', $catalog->id) }}" method="POST" style="display:inline;">
                                                ...
                                                <button type="submit" class="dropdown-item"
                                                    onclick="return confirm('Are you sure you want to delete this catalog item?')">
                                                    Delete
                                                </button>
                                            </form>
                                        </div>
            ...
            <div class="card-footer d-flex align-items-center">
                <p class="m-0 text-muted">
                    Showing
                    <span>
                        {{ ($catalogs->currentPage() - 1) * $catalogs->perPage() + 1 }}
                    </span>
                    to
                    <span>
                        {{ ($catalogs->currentPage() - 1) * $catalogs->perPage() + $catalogs->count() }}
                    </span>
                    of
                    <span>
                        {{ $catalogs->total() }}
