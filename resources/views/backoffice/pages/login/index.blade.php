...
<html lang="en">
  ...
  <body  class=" d-flex flex-column">
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        <div class="text-center mb-4">
          <a href="." class="navbar-brand navbar-brand-autodark"><img src="{{ asset('assets/backoffice/static/logo.svg') }}" height="36" alt=""></a>
        </div>
        <div class="d-flex justify-content-center p-4">
            @if ($errors->any())
                <x-backoffice.badge.error>
                    <ul class="mb-0">
        ...
        <div class="card card-md">
          <div class="card-body">
            ...
            <form action="{{ route('auth') }}" method="post" autocomplete="off" novalidate>
                @csrf
                <div class="mb-3">
                    <label class="form-label" for="email">Email address</label>
                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="your@email.com" value="{{ old('email') }}" autocomplete="off" required>
                    @error('email')
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-flat">
                        ...
                        <span class="input-group-text">
                            <a href="#" class="link-secondary" title="Show password" data-bs-toggle="tooltip" onclick="event.preventDefault(); var p=document.getElementById('password'); if(p.type==='password'){p.type='text';}else{p.type='password';}">
    ...
    <!-- Libs JS -->
    <!-- Tabler Core -->
    <script src="{{ asset('assets/backoffice/js/tabler.min.js?1684106062') }}" defer></script>
    <script src="{{ asset('assets/backoffice/js/demo.min.js?1684106062') }}" defer></script>
    @stack('js-sigin')
  </body>
</html>
